...
public class Payments_page extends AppCompatActivity {
    String Subtotal;
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(name.getText().toString().trim())) {
                    Toast.makeText(Payments_page.this, " Name is invalid", Toast.LENGTH_SHORT).show();

                } else if (TextUtils.isEmpty(upivirtualid.getText().toString().trim())) {
                    Toast.makeText(Payments_page.this, " UPI ID is invalid", Toast.LENGTH_SHORT).show();

                } else if (TextUtils.isEmpty(note.getText().toString().trim())) {
                    Toast.makeText(Payments_page.this, " Note is invalid", Toast.LENGTH_SHORT).show();

                } else if (TextUtils.isEmpty(amount.getText().toString().trim())) {
                    Toast.makeText(Payments_page.this, " Amount is invalid", Toast.LENGTH_SHORT).show();
                } else {
